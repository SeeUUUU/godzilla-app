...
interface TriMatchingBoardProps {
  words: WordItem[];
  clearedIds: number[];
  onMatchSuccess: (id: number) => void;
  onMatchFail: (failedIds?: number[]) => void;
  stageLabel?: string;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>{clearedIds.length}/{words.length}</span>
                </div>
              </div>
                ...
                {list.map((card) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 min-h-0 w-full px-2.5 sm:px-3 py-1 rounded-xl flex items-center justify-between font-black transition-all cursor-pointer ${
                    ...
                    >
                      ...
                      <div style={{ marginLeft: '4px', flexShrink: 0, display: 'flex', alignItems: 'center' }}>
                        {isCleared ? (
                          ...
                          <div
                            style={{
                              padding: '3px',
                              borderRadius: '6px',
                              backgroundColor: isSelected ? '#06b6d4' : 'rgba(15, 23, 42, 0.6)',
